...
Open [http://localhost:3000/2026](http://localhost:3000/2026) with your browser to see the result.

## Tech Stack

- Package Manager: npm
- Framework: Next.js with [TypeScript](https://nextjs.org/docs/pages/api-reference/config/typescript), [Oxlint](https://oxc.rs/docs/guide/usage/linter) and [Static Site Generation (SSG)](https://nextjs.org/docs/pages/building-your-application/rendering/static-site-generation)
...
- `Speaker`: Universal information about speakers that does not change depending on the talk is registered in the Speaker section.
  - See `2026/src/constants/talks.ts`
...
- `Session`: contains information such as the location and time of the session
  - See `2026/src/constants/schedule.ts`
...
Please modify `VOLUNTEER_TEAM` in the `2026/src/constants/team.ts` and submit a pull request.
