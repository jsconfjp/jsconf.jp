...
機械学習・最適化・生成AIなどの先進テクノロジーと三菱商事の産業知見をかけあわせ、顧客と社会の課題解決に取り組んでいます。

多様な技術領域を横断しながら、エンジニアとしての視野と専門性を広げることができます。

まだ答えのない課題に、技術で挑む。産業の未来を、ともにつくりませんか。
`.trim(),
  },
  {
    type: "sponsor",
...
`.trim(),
  },
  {
    ...
    logoUrl: "/2026/sponsor/enechain-2026.png",
    prText:
      `enechainは電力・燃料・環境価値を扱うエネルギーのマーケットプレイスを運営するスタートアップです。そして最近のニュースではエネルギーの話題が尽きません。2016年の電力完全自由化・脱炭素の加速を背景に、エネルギー取引のリスク管理ニーズは急拡大しています。レガシーな領域且つ高い技術要求が求められる国家インフラ級のプラットフォームを、モダンな技術で自社エンジニアチームが開発することにこだわっています。JSカンファレンスに集まるエンジニアの皆さんと一緒に、場を精一杯に盛り上げていきます！ぜひよろしくお願いします！`.trim(),
  },
  {
    type: "sponsor",
    plan: "premium",
